    ...
    <>
      <WodaMissingBanner
        fields={[
          ...
          { key: "applicant_earning_guardian", label: "Earning Guardian" },
          { key: "fiscal_1_bs", label: "Fiscal Year 1 (B.S.)" },
          { key: "fiscal_2_bs", label: "Fiscal Year 2 (B.S.)" },
          { key: "fiscal_3_bs", label: "Fiscal Year 3 (B.S.)" },
          {
            key: "occupations",
            label: "Income Occupations (at least one)",
            check: (v) => Array.isArray(v) && v.length > 0,
          },
          { key: "usd_rate", label: "USD Exchange Rate" },
          { key: "rate_date", label: "Exchange Rate Date" },
